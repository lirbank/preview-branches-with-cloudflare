...
1. In CF Dashboard, create a secret under _Build_ (not under _Variables and Secrets_) called `NEON_API_KEY` and add the Neon API key.
1. In CF Dashboard, create a variable under _Build_ (not under _Variables and Secrets_) called `NEON_PROJECT_ID` and set it to you Neon project ID.
